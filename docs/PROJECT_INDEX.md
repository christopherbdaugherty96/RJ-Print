# RJ Print Project Index

Status: navigation document

## Purpose

Central index for the RJ Print planning repository.
...
If a planning document and a status document disagree, CURRENT_STATUS.md should be treated as the current project truth layer until updated.
